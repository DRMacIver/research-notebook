...
\item ``A part can be reliable, but in and of itself it can't be safe. It can perform its stated function to the expected level or amount, but it is context, the cotext of other parts, of the dynamics and the interactions and cross-adaptations between parts, that make things safe or unsafe''. (p. 78)
\end{itemize}
